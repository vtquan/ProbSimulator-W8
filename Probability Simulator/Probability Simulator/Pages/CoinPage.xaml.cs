...
namespace Probability_Simulator
{
    ...
    public sealed partial class CoinPage : Probability_Simulator.Common.LayoutAwarePage
    {
        ...
        private async void testInput()    //test if input is correct
        {
            ...
            if (Int32.TryParse(numCoinBox.Text, out numCoin) != false && numCoin <= 1000)   //if input is valid 
            {
        ...
        private void coinFlip(int numFlip)
        {
            ...
            //update image
            BitmapImage coinHeadBrush = new BitmapImage(new Uri("ms-appx:///Assets/penny-head.jpg", UriKind.RelativeOrAbsolute));
            BitmapImage coinTailBrush = new BitmapImage(new Uri("ms-appx:///Assets/penny-tail.jpg", UriKind.RelativeOrAbsolute));
